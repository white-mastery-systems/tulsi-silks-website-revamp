    ...
    if(this.commonService.store_id) {
      ...
      this.router.events.subscribe(event => {
        if(event instanceof NavigationEnd) {
          ...
          if(routeName.indexOf("/category/")==-1 && routeName.indexOf("/product/")==-1 && routeName.indexOf("/blogs")==-1 && routeName.indexOf("/account")==-1 && routeName.indexOf("/wishlist")==-1 && routeName.indexOf("/contact-us")==-1 && routeName.indexOf("/404")==-1) {
