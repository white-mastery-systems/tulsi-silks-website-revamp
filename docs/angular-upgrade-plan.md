...
Next: commit on branch `upgrade/angular-16`, push, PR → merge, then `upgrade/angular-17` for the following hop. **Smoke-test** price/category sliders and quicklink preloading after deploy.
