...
Next: commit on branch `upgrade/angular-17`, push, PR → merge, then `upgrade/angular-18` for the following hop. **Smoke-test** SSR (sitemap, robots, redirects), sliders, and quicklink preloading after deploy.
