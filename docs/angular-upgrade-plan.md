...
Next: commit on branch `upgrade/angular-18`, push, PR → merge, then `upgrade/angular-19` for the following hop. **Smoke-test** HTTP (interceptors), modals/accordion (`ngx-bootstrap`), sliders, QR, and SSR after deploy.
